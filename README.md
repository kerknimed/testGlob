...
Cette fonction prend comme paramètre un tableau qui présente des intervalles fermés et envoyer comme une sortie l'union des intervalles.

### Question 2

Codez cette fonction. ( globalTest.html )
